...
import static com.payment_cracker.api.dao.high_level.generate_names.Randomness.random;

public class EnglishlikeNameGenerator implements NameGenerator {

	private static final List<String> maleGivenNames = Arrays.asList("Kevin","Dave","David","Alan","Derek","Paul","Nick","Mark","Sam","Dan","Robert","Gavin","Terry","Barry","Rahul","Steve","John","Naeem","Harris", "Viktor", "Yuriy", "Vyacheslav", "Andrew");
	private static final List<String> femaleGivenNames = Arrays.asList("Natalie","Sarah","Deidre","Gladys","Penny","Rebecca","Grace","Kelly","Sally","Maggie","Kate","Kathryn", "Eva", "Irina", "Yulia", "Svetlana", "Nataliya");
